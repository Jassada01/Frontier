            ...
            <form @submit.prevent="updateUser">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex justify-around">
                        <button type="button" class="btn btn-info" @click="triggerSignFileInput">อัพโหลดลายเซ็น</button>
                        <button type="button" class="btn btn-info ml-2" @click="openSignatureModal">วาดลายเซ็น</button>
                    </div>
                </div>
...
const fetchUserData = async () => {
    try {
        ...
        const userResponse = await axios.get(`${CONFIG.API_SERVER}/api/users/user/${userId}`);
