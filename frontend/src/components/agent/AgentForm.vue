...
const fetchAgentData = async (id) => {
    try {
        ...
        Swal.fire('Error', 'Error fetching agent data: ' + error.response.data.message, 'error')
    }
}
...
const createAgent = async () => {
    ...
    try {
        ...
        Swal.fire('Error', 'Error creating agent: ' + error.response.data.message, 'error')
    }
}
...
const updateAgent = async () => {
    ...
    try {
        ...
        Swal.fire('Error', 'Error updating agent: ' + error.response.data.message, 'error')
    }
}
